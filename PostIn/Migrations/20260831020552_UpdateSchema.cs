    ...
    public partial class UpdateSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_Dipendente = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    StatoAccount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_Articolo = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Titolo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CorpoTesto = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    FK_Autore = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FK_Dipendente = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FK_Follower = table.Column<int>(type: "int", nullable: false),
                    FK_Followed = table.Column<int>(type: "int", nullable: false),
                    DataInizioInterazione = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FK_Articolo = table.Column<int>(type: "int", nullable: false),
                    FK_Categoria = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_Commento = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FK_Articolo = table.Column<int>(type: "int", nullable: false),
                    FK_Autore = table.Column<int>(type: "int", nullable: false),
                    TestoCommento = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_Visualizzazione = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FK_Dipendente = table.Column<int>(type: "int", nullable: false),
                    FK_Articolo = table.Column<int>(type: "int", nullable: false),
                    DataOraVisualizzazione = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
